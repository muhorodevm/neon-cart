...
const slides = [
  {
    ...
    description:
      "Cheki hizi latest kicks, ma-design ni kali na tech iko juu sana!",
    image:
  ...
  },
  {
    ...
    description:
      "Experience unparalleled comfort with our revolutionary Air Max technology.",
    image:
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?w=1920&h=1080&fit=crop",
    cta: "View Collection",
  },
];
    ...
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center text-white h-full w-full px-6">
            {" "}
